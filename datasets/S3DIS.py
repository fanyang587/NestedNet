...
class S3DISDataset(Dataset):
    ...
    def __init__(self, input_threads=8):
        ...
        self.path = '/raid/workspace/project/F/find/Stanford3dDataset_v1.2'
    ...
    def load_subsampled_clouds(self, subsampling_parameter):
        ...
        # Initiate containers
        self.input_trees = {'training': [], 'validation': [], 'search':[]}
        self.input_colors = {'training': [], 'validation': [], 'search':[]}
        self.input_labels = {'training': [], 'validation': [], 'search':[]}
        ...
        for i, file_path in enumerate(self.train_files):
            ...
            elif self.all_splits[i] == self.search_split:
                cloud_split = 'search'
            else:
        ...
        self.num_search = len(self.input_trees['search'])
