...
from models.network_blocks_sh_stage6 import assemble_SHCNN_blocks, segmentation_head, multi_segmentation_head
from models.network_blocks_sh_stage6 import segmentation_loss, multi_segmentation_loss
...
class KernelPointFCNN:
    ...
    def __init__(self, flat_inputs, config, hw, mw, lw, hw2, mw2, lw2, h2m, m2l):
        """
        Initiate the model
        ...
        with tf.variable_scope('KernelPointNetwork'):
            output_features = assemble_SHCNN_blocks(self.inputs,
                                                    self.config,
                                                    self.dropout_prob, self.hw, self.mw, self.lw, hw2, mw2, lw2, h2m, m2l)
